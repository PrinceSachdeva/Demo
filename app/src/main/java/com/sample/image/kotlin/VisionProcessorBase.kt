...
import com.sample.image.kotlin.preference.PreferenceUtils
...
abstract class VisionProcessorBase<T>(context: Context) : VisionImageProcessor {
  ...
  private fun requestDetectInImage(
    ...
    return detectInImage(image).addOnSuccessListener(executor) { results: T ->
      ...
      if (originalCameraImage != null && false) {
        graphicOverlay.add(
          CameraImageGraphic(
            graphicOverlay,
            originalCameraImage
  ...
  protected abstract fun onSuccess(results: T, graphicOverlay: GraphicOverlay, originalBitmap : Bitmap)
